<template>
	<view class="container">
		<tui-navigation-bar backgroundColor="#fff" :isFixed="false" :isOpacity="false">
			<view class="nav">
				<view class="n-left" @click='back'>
					<view><tui-icon name="arrowleft" size="24"></tui-icon></view>
					<view>发布</view>
				</view>
		...
		<view class="main">
			...
			<view class="content">
				<input type="text" placeholder="请输入标题" maxlength="20" class="title-input" v-model="imgInfo.title" />
			</view>
			<view class="content">
			...
			<view class="tag" @click="show">
				...
				<view class="right">
					<view ><tui-icon name="arrowright"></tui-icon></view>
				</view>
			</view>
			<view class="tag"  @click="nextAddTag">
				<view class="icon">
